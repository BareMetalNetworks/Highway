...
# GNU Readline supported Ctrl-* and Alt-* emacs keybindings available\n
  Usage: #{exec_name} <options> \n""   "
    ...
    opts.on('-l', '--logging [FILE]', 'Turn logging on') {|x|
      options[:repl] = true || false}
...
$SRVLIST = Redis::List.new('nodes:allips') #:marshall => true

  #
  # p $SRVLIST.length
  # p $SRVLIST.values

allIps = %w{10.0.1.200 10.0.1.32 10.0.1.27 10.0.1.10 10.0.1.7 10.0.1.19 10.0.1.20 10.0.1.21 10.0.1.22 10.0.1.28
